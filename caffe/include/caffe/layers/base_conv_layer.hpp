...
class BaseConvolutionLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  void normalized_forward_cpu_gemm(const Dtype* weights, Dtype* output, bool skip_im2col = false);
  void normalized_backward_cpu_img_gemm(const Dtype* top_diff, const Dtype* weights, Dtype* output_img);
  void normalized_backward_cpu_emb_gemm(const Dtype* top_diff, const Dtype* weights, Dtype* output_emb);
  void normalized_weight_cpu_gemm(const Dtype* output, Dtype* weights);
  void backward_cpu_scale(Dtype* scale_diff, const Dtype* weights, const Dtype* emb, const Dtype* top_diff);
  void normalized_cpu_prep_buffers(const Dtype* weights, const Dtype* input_img, const Dtype* input_emb);
  void normalized_backward_cpu_all(const Dtype* top_diff, 
				   const Dtype* weights, 
				   const Dtype* img, 
				   const Dtype* emb, 
				   Dtype* weight_diff,
  ...
  void normalized_forward_gpu_gemm(const Dtype* weights, Dtype* output, bool skip_im2col = false);
  void normalized_backward_gpu_img_gemm(const Dtype* top_diff, const Dtype* weights, Dtype* output_img);
  void normalized_backward_gpu_emb_gemm(const Dtype* top_diff, const Dtype* weights, Dtype* output_emb);
  void normalized_weight_gpu_gemm(const Dtype* output, Dtype* weights);
  void backward_gpu_scale(Dtype* scale_diff, const Dtype* weights, const Dtype* emb, const Dtype* top_diff);
  void normalized_gpu_prep_buffers(const Dtype* weights, const Dtype* input_img, const Dtype* input_emb);
  void normalized_backward_gpu_all(const Dtype* top_diff, 
				   const Dtype* weights, 
				   const Dtype* img, 
				   const Dtype* emb, 
				   Dtype* weight_diff,
