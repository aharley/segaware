#ifndef CAFFE_NOSP_CONV_MEANFIELD_LAYER_HPP_
#define CAFFE_NOSP_CONV_MEANFIELD_LAYER_HPP_
...
class NospConvMeanfieldLayer : public Layer<Dtype> {

 public:
  explicit NospConvMeanfieldLayer(const LayerParameter& param) : Layer<Dtype>(param) {}
 ...
 protected:
  ...
  vector<shared_ptr<NospConvMeanfieldIteration<Dtype> > > meanfield_iterations_;
...
#endif  // CAFFE_NOSP_CONV_MEANFIELD_LAYER_HPP_
