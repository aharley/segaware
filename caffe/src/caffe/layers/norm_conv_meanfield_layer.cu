...
void NormConvMeanfieldLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
 ...
 */
template<typename Dtype>
void NormConvMeanfieldLayer<Dtype>::Backward_gpu(
...
INSTANTIATE_LAYER_GPU_FUNCS(NormConvMeanfieldLayer);
}  // namespace caffe
